...
export function Header() {
  ...
  return (
    <header className="sticky top-[env(safe-area-inset-top,0px)] z-50 border-b hairline bg-ivory/[.93] backdrop-blur-md">
      ...
      {menu && (
        <nav className="anim-drawer fixed inset-x-0 bottom-0 top-[calc(4.5rem+env(safe-area-inset-top,0px))] z-40 flex flex-col justify-between overflow-y-auto bg-ivory px-6 pb-10 pt-8 md:hidden" aria-label="Mobile">
